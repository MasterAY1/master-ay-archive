...
export default function App() {
  ...
  const BackButton = () => (
    <button 
      ...
      className="fixed bottom-5 left-5 md:bottom-8 md:left-8 z-[999] px-4 py-2 md:py-2.5 text-xs font-medium text-[#808080] bg-black/60 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl hover:bg-white/10 hover:text-white transition-all duration-300 flex items-center gap-2 group"
    >
