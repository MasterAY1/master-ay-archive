...
export default function App() {
  ...
  const BackButton = () => (
    <button 
      ...
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[999] px-4 py-2 text-xs font-medium text-[#808080] bg-black/40 backdrop-blur-md border border-white/5 rounded-full shadow-lg hover:bg-white/10 hover:text-white hover:border-white/20 transition-all duration-300 flex items-center gap-1.5"
    >
